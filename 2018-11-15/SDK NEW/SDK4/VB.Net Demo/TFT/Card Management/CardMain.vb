...
#Region "Card Operation"
    ...
    Private Sub lvCard_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvCard.SelectedIndexChanged

    End Sub

    Private Sub rtTimer_Tick(sender As Object, e As EventArgs) Handles rtTimer.Tick
