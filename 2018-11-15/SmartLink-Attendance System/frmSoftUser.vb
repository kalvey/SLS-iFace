...
Public Class frmSoftUser
    ...
    Sub registerUser()
        ...
        ''' </summary>
        openConnection()
        Dim cmd As New SqlCommand("INSERT INTO tUser(userId,username,password,status,createdBy,createdDate,createdAt) VALUES (@userId, @userName, @password, @status,@createdBy, @createdDate, @createdAt)", conn)
        ...
        cmd.Parameters.AddWithValue("@createdAt", Environment.MachineName)
        cmd.ExecuteNonQuery()
