...
Public Class frmEMPtoPRJ
    ...
    Sub SearchData()
        Try
	        ...
	        TelpNo 'Telephone Number', txtAddr 'Address',contractStartDate 
	        'Contract Start Date', contractEndDate 'Contract End Date', 
	        [status] 'Status' FROM tDeviceUser2 where employeeNo Like '%" + txtSearch.Text + "%" + "' or employeeName Like '%" + txtSearch.Text + "%" + "' or identityNo Like '%" + txtSearch.Text + "%" + "' or employeeType Like '%" + txtSearch.Text + "%" + "'or departmentNo Like '%" + txtSearch.Text + "%" + "'or departmentName Like '%" + txtSearch.Text + "%" + "' ", conn)
