...
Public Class frmMasterData
    ...
    Sub showEmployee()
        Try
	        ...
	        identityNo 'Identity Number', employeeType 'Employee Type', tUserExternal.subcon 'Subcon',
    ...
    Private Sub frmAddGroup_Click(sender As Object, e As EventArgs) Handles frmAddGroup.Click
        Dim newAddGroup As New frmAddGroup
        newAddGroup.Show()
    End Sub
