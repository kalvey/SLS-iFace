...
Public Class frmEditProject
    ...
    Private Sub frmEditProject_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim index = frmMasterData.dgvMasterPRJ.CurrentCell.RowIndex
            openConnection()
            Dim adaptor As New SqlDataAdapter(
            " SELECT * FROM tProjectDet WHERE projectCode = '" & frmMasterData.dgvMasterPRJ.Rows(index).Cells(0).Value & "'", conn)
