...
Public Class frmReport
    ...
    Private Sub frmReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        populateCombobox()
        populateComboboxSC()
        populateComboboxSCAtt()
        populateComboboxSCLate()
        populateComboboxSCEP()
        populateComboboxSCOT()
        populateProject()
    ...
    Sub populateComboboxSCEP()
        Try
            ...
            Dim table2 As New DataTable()
            myDA.Fill(table2)
            cbbEPSubcon.DataSource = table2
            cbbEPSubcon.ValueMember = "subconName"
            cbbEPSubcon.DisplayMember = "subconName"
    ...
    Sub populateProject()
        Try
            openConnection()
            'dim connection As New MySqlConnection("Server=192.168.1.88;Database=in-ihis;Uid=root;password=ptgiat1899")
            Dim command As New SqlCommand("SELECT * FROM tProject", conn)
            Dim myDA As SqlDataAdapter = New SqlDataAdapter(command)
            Dim table2 As New DataTable()
            myDA.Fill(table2)
            cbbProject.DataSource = table2
            cbbProject.ValueMember = "ProjectName"
            cbbProject.DisplayMember = "ProjectName"
    ...
    Sub populateComboboxSCOT()
        Try
            ...
            Dim table2 As New DataTable()
            myDA.Fill(table2)
            cbbSCOT.DataSource = table2
            cbbSCOT.ValueMember = "subconName"
            cbbSCOT.DisplayMember = "subconName"
    ...
    Sub populateComboboxSCAtt()
        Try
            ...
            Dim table2 As New DataTable()
            myDA.Fill(table2)
            cbbAttSC.DataSource = table2
            cbbAttSC.ValueMember = "subconName"
            cbbAttSC.DisplayMember = "subconName"
    ...
    Sub populateComboboxSCLate()
        Try
            ...
            Dim table2 As New DataTable()
            myDA.Fill(table2)
            cbbLateSC.DataSource = table2
            cbbLateSC.ValueMember = "subconName"
            cbbLateSC.DisplayMember = "subconName"
            conn.Close()
        Catch ex As Exception
            MsgBox(ex.ToString())
            saveError(ex.ToString())
    ...
    Private Sub btnAttendance_Click(sender As Object, e As EventArgs) Handles btnAttendance.Click
        ...
        If cbbDepart.Text = "" And txtSearchEMP.Text = "" Then
            ...
            SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department Name', tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon', " & result2 & "
            
            FROM #tTemp INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tTemp.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tTemp.userId
        ...
        ElseIf cbbDepart.Text <> "" And txtSearchEMP.Text = "" Then
            ...
            SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department Name', tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon', " & result2 & "
            FROM #tTemp INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tTemp.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tTemp.userId WHERE tDeviceUser2.departmentName  Like '%" + cbbDepart.Text + "%" + "'
        ...
        ElseIf cbbDepart.Text = "" And txtSearchEMP.Text <> "" Then
            ...
            FROM #tTemp INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tTemp.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tTemp.userId 
            WHERE tDeviceUser2.employeeName  Like '%" + txtSearchEMP.Text + "%" + "'
        ...
        ElseIf cbbDepart.Text <> "" And txtSearchEMP.Text <> "" Then
            ...
            FROM #tTemp INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tTemp.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tTemp.userId 
            WHERE tDeviceUser2.departmentName  Like '%" + cbbDepart.Text + "%" + "' 
    ...
    Public Sub exportExit(ByVal dgv As DataGridView)
        ...
        Try
            ...
            With xlWorkSheet
                ...
                Dim arrHeader As String() = {"NULL", "NO", "EMPNO", "EMPNAME", "DEPARTMENT", "SECTION", "POSITION", "SUBCON"}
                ...
                For I = 0 To days.Count - 1
                    .Cells(4, 8 + addDays) = days(I)
                    .Cells(4, 8 + addDays).interior.color = Color.Gold
                    .Range(.Cells(4, 8 + addDays), .Cells(4, 8 + addDays)).Borders.LineStyle = Excel.XlLineStyle.xlContinuous
                    addDays += 1
                ...
                For j = 0 To list.Count - 1
                    .Cells(5, 8 + addDate) = list(j)
                    .Cells(5, 8 + addDate).interior.color = Color.Gold
                    .Range(.Cells(5, 8 + addDate), .Cells(5, 8 + addDate)).Borders.LineStyle = Excel.XlLineStyle.xlContinuous
                    addDate += 1
                Next

                'Merge First 4 Headers
                For head As Integer = 1 To 7
                ...
                Dim nextHeader As Integer = 7 + System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month)
                ...
                .Range(.Cells(1, 1), .Cells(1, 7 + System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month))).Merge()
                .Range(.Cells(2, 1), .Cells(2, 7 + System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month))).Merge()
                .Range(.Cells(3, 1), .Cells(3, 7 + System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month))).Merge()
    ...
    Public Sub ExportToExcel(ByVal dgv As DataGridView)
        ...
        Try
            ...
            With xlWorkSheet
                ...
                Dim nextHeader As Integer = 7 + System.DateTime.DaysInMonth(dtpAtt.Value.Year, dtpAtt.Value.Month)
    ...
    Sub getLateAttendance()
        ...
        For t As Integer = 0 To dgvLate.Rows.Count - 1
            total = 0
            For k As Integer = 7 To dgvLate.Columns.Count - 2
            ...
            Next
            dgvLate.Rows(t).Cells(7 + System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month)).Value = total
        Next

        Dim cellvaluescount As Integer = 0
        For iCol As Integer = 0 To dgvLate.Rows.Count - 1
            cellvaluescount = 0
            For jCol As Integer = 7 To System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month)
                If dgvLate.Rows(iCol).Cells(jCol).Value <> 0 And dgvLate.Rows(iCol).Cells(jCol).Value > 0 Then
                    cellvaluescount = cellvaluescount + 1
                End If
            Next
            dgvLate.Rows(iCol).Cells(8 + System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month)).Value = cellvaluescount
        Next
        Dim count As Integer = 0
        ...
        For tt As Integer = 0 To dgvLate.Rows.Count - 1
            total = 0
            For kk As Integer = 7 To dgvLate.Columns.Count - 2
        ...
        For tt1 As Integer = 0 To dgvLate.Rows.Count - 1
            total = 0
            For kk1 As Integer = 7 To dgvLate.Columns.Count - 2
                values = dgvLate.Rows(tt1).Cells(kk1).Value.ToString
                If values.ToString Is Nothing Or values = "" Or values = "0" Then

                    '     MsgBox("nothing")
                    values = 0
                Else
                    If Convert.ToInt64(values) > 100 Then
                        dgvLate.Rows(tt1).Cells(kk1).Value = DBNull.Value
                    End If
                End If
            Next
        Next
    ...
    Sub getTotalMP()
        ...
        For t As Integer = 0 To DataGridView3.Rows.Count - 1
            ...
            '         dgvMerge.Rows(t).Cells(4 + System.DateTime.DaysInMonth(dtpSubProject.Value.Year, dtpSubProject.Value.Month)).Value = total
        Next
    End Sub
    Sub getTotalMP2()
        'Dim total, increment As Integer
        'total = 0
        'increment = 0
        'For t As Integer = 0 To dgvMerge .Rows.Count - 1
        '    total = 0
        '    For k As Integer = 2 To dgvMerge.Columns.Count - 2
        '        total = total + DataGridView3.Rows(t).Cells(k).Value
        '    Next

        '    dgvMerge.Rows(t).Cells(3 + System.DateTime.DaysInMonth(dtpSubProject.Value.Year, dtpSubProject.Value.Month)).Value = total
        'Next
    End Sub
    Sub getTotalAttendance()
        ...
        For t As Integer = 0 To dgvEmployee.Rows.Count - 1
            ...
            For k As Integer = 7 To dgvEmployee.Columns.Count - 2
            ...
            dsAttendance.Tables(0).Rows(t)(6 + System.DateTime.DaysInMonth(dtpAtt.Value.Year, dtpAtt.Value.Month)) = total
    ...
    'Sub GetWeekend()
    '    Try
    '        Dim headerText As DateTime
    '        For i As Integer = 0 To dgvLate.Rows.Count
    '            For j As Integer = 8 To dgvLate.Columns.Count
    '                headerText = Convert.ToDateTime(dgvLate.Columns(j).HeaderText)
    '                If headerText.DayOfWeek.ToString() = "Sunday" Then
    '                    dgvLate.Rows(i).Cells(j).Value = ""
    '                Else
    ...
    Private Sub btnGetLate_Click_1(sender As Object, e As EventArgs) Handles btnGetLate.Click
        ...
        For i As Integer = 1 To System.DateTime.DaysInMonth(dtpLateAtt.Value.Year, dtpLateAtt.Value.Month)
            ...
            query.Add("CASE WHEN DATENAME(WeekDay,'" & dd & "') = 'Sunday' OR EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "') THEN NULL ELSE [" & dd & "] END AS [" & dd & "]")
        Next
        Dim result As String = String.Join(", ", days)
        Dim CaseQuery As String = String.Join(",", query)
        ...
        Dim adaptor As New SqlDataAdapter
            ...
            SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department', tDeviceUser2.position 'Position', tDeviceUser2.section 'Section', tUserExternal.subcon 'Subcon',  " & CaseQuery & "
            FROM #tLate FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId ORDER BY tDeviceUser2.userId ASC
        ...
        ElseIf cbbLateDPT.Text <> "" And txtLateEMPname.Text = "" Then
            ...
            SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department', tDeviceUser2.position 'Position', tDeviceUser2.section 'Section', tUserExternal.subcon 'Subcon',   " & CaseQuery & "
            FROM #tLate FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId
            WHERE tDeviceUser2.departmentName Like '%" + cbbLateDPT.Text + "%" + "' ORDER BY tDeviceUser2.userId ASC
        ...
        ElseIf txtLateEMPname.Text <> "" And cbbLateDPT.Text = "" Then
            ...
            FROM #tLate FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId
            WHERE tDeviceUser2.employeeName Like '%" + txtLateEMPname.Text + "%" + "' ORDER BY tDeviceUser2.userId ASC
        ...
        ElseIf cbbLateDPT.Text <> "" And txtLateEMPname.Text <> "" Then
            ...
            FROM #tLate FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId
            WHERE tDeviceUser2.departmentName Like '%" + cbbLateDPT.Text + "%" + "' AND tDeviceUser2.employeeName Like '%" + txtLateEMPname.Text + "%" + "'ORDER BY tDeviceUser2.userId ASC
    ...
    Private Sub btnGetExit_Click(sender As Object, e As EventArgs) Handles btnGetExit.Click
        ...
        Dim adaptor As New SqlDataAdapter
        openConnection()
        If cbDeptExit.Text = "" And txtEPEmp.Text = "" Then
            ...
            adaptor = New SqlDataAdapter("
                ...
                SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department',tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon',  " & result & "
                FROM #tLate INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId
                LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId
        ...
        ElseIf txtEPEmp.Text <> "" And cbDeptExit.Text = "" Then
            adaptor = New SqlDataAdapter("
                ...
                SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department',tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon',  " & result & "
                FROM #tLate INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId 
                LEFT JOIN tUserExternal on tUserExternal.userId = #tLate.userId  WHERE tDeviceUser2.userId LIKE '%" & txtEPEmp.Text & "%' OR tDeviceUser2.employeeName LIKE '%" & txtEPEmp.Text & "%'
        ...
        ElseIf cbDeptExit.Text <> "" And txtEPEmp.Text = "" Then
            ...
            adaptor = New SqlDataAdapter("
                ...
                SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department',tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon',  " & result & "
                FROM #tLate INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId 
                LEFT JOIN tUserExternal on tUserExternal.userId = #tLate.userId WHERE tDeviceUser2.departmentName LIKE '" & cbDeptExit.Text & "'
    ...
    'End Sub
    Sub showProjectName2()
        '    Sub showDGV()
        Try
            openConnection()
            Dim adaptor As New SqlDataAdapter("SELECT * FROM tProject WHERE projectName = '" & cbbProject.Text & "'", conn)
            Dim ds As New DataSet
            adaptor.Fill(ds, "Report")
    ...
    Sub showProjectName()
        ...
        Try
            openConnection()
            Dim adaptor As New SqlDataAdapter("SELECT * FROM tProject", conn)
            Dim ds As New DataSet
            adaptor.Fill(ds, "Report")
            DataGridView2.DataSource = ds.Tables("Report")
        Catch ex As Exception
    ...
    Sub showProject()
        ...
        Try
            openConnection()
            Dim adaptor As New SqlDataAdapter("SELECT * FROM tProjectDet", conn)
            Dim ds As New DataSet
            adaptor.Fill(ds, "Report")
    ...
    Sub showProject2()
        ...
        Try
            openConnection()
            Dim adaptor As New SqlDataAdapter("SELECT * FROM tProjectDet where subCont = '" & cbbProject.Text & "'", conn)
            Dim ds As New DataSet
            adaptor.Fill(ds, "Report")
            DataGridView1.DataSource = ds.Tables("Report")
        Catch ex As Exception
    ...
    Private Sub btnSubProject_Click(sender As Object, e As EventArgs) Handles btnSubProject.Click
        ...
        For j As Integer = 0 To dgvSubProject.Rows.Count - 1
            ...
            For i As Integer = 1 To System.DateTime.DaysInMonth(dtpSubProject.Value.Year, dtpSubProject.Value.Month)
                ...
                select DISTINCT tprojectemp.employeeno 'employee number', tprojectemp.employeename 'employee name', 
                ...
                inner join treport on tprojectemp.employeeName = treport.personellName where projectName = '" & dgvSubProject.Rows(j).Cells(1).Value & "'
        ...
        For iCol As Integer = 0 To dgvSubProject.Columns.Count - 1
            dgvMerge.Columns.Add("col" & iCol, dgvSubProject.Columns(iCol).HeaderText)
        Next

        For iCol2 As Integer = 0 To DataGridView3.Columns.Count - 1
            dgvMerge.Columns.Add("Coll" & iCol2, DataGridView3.Columns(iCol2).HeaderText)
        Next
        Dim listColumnName As New List(Of String)
        For i As Integer = 0 To DataGridView3.Rows.Count - 1
            listColumnName.Add("DataGridView3.rows(iRows).cells(" & i & ").Value.ToString()")
        Next

        If System.DateTime.DaysInMonth(dtpSubProject.Value.Year, dtpSubProject.Value.Month) = 31 Then
            For iRows As Integer = 0 To dgvSubProject.Rows.Count - 1
                dgvMerge.Rows.Add(dgvSubProject.Rows(iRows).Cells(0).Value.ToString, dgvSubProject.Rows(iRows).Cells(1).Value.ToString, dgvSubProject.Rows(iRows).Cells(2).Value.ToString(), dgvSubProject.Rows(iRows).Cells(3).Value.ToString(), dgvSubProject.Rows(iRows).Cells(4).Value.ToString(), DataGridView3.Rows(iRows).Cells(0).Value.ToString(), DataGridView3.Rows(iRows).Cells(1).Value.ToString(), DataGridView3.Rows(iRows).Cells(2).Value.ToString(), DataGridView3.Rows(iRows).Cells(3).Value.ToString(), DataGridView3.Rows(iRows).Cells(4).Value.ToString(), DataGridView3.Rows(iRows).Cells(5).Value.ToString(), DataGridView3.Rows(iRows).Cells(6).Value.ToString(), DataGridView3.Rows(iRows).Cells(7).Value.ToString(), DataGridView3.Rows(iRows).Cells(8).Value.ToString(), DataGridView3.Rows(iRows).Cells(9).Value.ToString(), DataGridView3.Rows(iRows).Cells(10).Value.ToString(), DataGridView3.Rows(iRows).Cells(11).Value.ToString(), DataGridView3.Rows(iRows).Cells(12).Value.ToString(), DataGridView3.Rows(iRows).Cells(13).Value.ToString(), DataGridView3.Rows(iRows).Cells(14).Value.ToString(), DataGridView3.Rows(iRows).Cells(15).Value.ToString(), DataGridView3.Rows(iRows).Cells(16).Value.ToString(), DataGridView3.Rows(iRows).Cells(17).Value.ToString(), DataGridView3.Rows(iRows).Cells(18).Value.ToString(), DataGridView3.Rows(iRows).Cells(19).Value.ToString(), DataGridView3.Rows(iRows).Cells(20).Value.ToString(), DataGridView3.Rows(iRows).Cells(21).Value.ToString(), DataGridView3.Rows(iRows).Cells(22).Value.ToString(), DataGridView3.Rows(iRows).Cells(23).Value.ToString(), DataGridView3.Rows(iRows).Cells(24).Value.ToString(), DataGridView3.Rows(iRows).Cells(25).Value.ToString(), DataGridView3.Rows(iRows).Cells(26).Value.ToString(), DataGridView3.Rows(iRows).Cells(27).Value.ToString(), DataGridView3.Rows(iRows).Cells(28).Value.ToString(), DataGridView3.Rows(iRows).Cells(29).Value.ToString(), DataGridView3.Rows(iRows).Cells(30).Value.ToString(), DataGridView3.Rows(iRows).Cells(31).Value.ToString())
            Next
            '  dgvMerge.Rows.Add(lst(0), lst(1), lst(2), lst(3), lst(4), lst(5), lst(6), lst(7), lst(8), lst(9), lst(10), lst(11), lst(12), lst(13), lst(14), lst(15), lst(16), lst(17), lst(18), lst(19), lst(20), lst(21), lst(22), lst(23), lst(24), lst(25), lst(26), lst(27), lst(28), lst(29), lst(30))

        ElseIf System.DateTime.DaysInMonth(dtpSubProject.Value.Year, dtpSubProject.Value.Month) = 30 Then
            For iRows As Integer = 0 To dgvSubProject.Rows.Count - 1
                dgvMerge.Rows.Add(dgvSubProject.Rows(iRows).Cells(0).Value.ToString, dgvSubProject.Rows(iRows).Cells(1).Value.ToString, dgvSubProject.Rows(iRows).Cells(2).Value.ToString(), dgvSubProject.Rows(iRows).Cells(3).Value.ToString(), dgvSubProject.Rows(iRows).Cells(4).Value.ToString(), DataGridView3.Rows(iRows).Cells(0).Value.ToString(), DataGridView3.Rows(iRows).Cells(1).Value.ToString(), DataGridView3.Rows(iRows).Cells(2).Value.ToString(), DataGridView3.Rows(iRows).Cells(3).Value.ToString(), DataGridView3.Rows(iRows).Cells(4).Value.ToString(), DataGridView3.Rows(iRows).Cells(5).Value.ToString(), DataGridView3.Rows(iRows).Cells(6).Value.ToString(), DataGridView3.Rows(iRows).Cells(7).Value.ToString(), DataGridView3.Rows(iRows).Cells(8).Value.ToString(), DataGridView3.Rows(iRows).Cells(9).Value.ToString(), DataGridView3.Rows(iRows).Cells(10).Value.ToString(), DataGridView3.Rows(iRows).Cells(11).Value.ToString(), DataGridView3.Rows(iRows).Cells(12).Value.ToString(), DataGridView3.Rows(iRows).Cells(13).Value.ToString(), DataGridView3.Rows(iRows).Cells(14).Value.ToString(), DataGridView3.Rows(iRows).Cells(15).Value.ToString(), DataGridView3.Rows(iRows).Cells(16).Value.ToString(), DataGridView3.Rows(iRows).Cells(17).Value.ToString(), DataGridView3.Rows(iRows).Cells(18).Value.ToString(), DataGridView3.Rows(iRows).Cells(19).Value.ToString(), DataGridView3.Rows(iRows).Cells(20).Value.ToString(), DataGridView3.Rows(iRows).Cells(21).Value.ToString(), DataGridView3.Rows(iRows).Cells(22).Value.ToString(), DataGridView3.Rows(iRows).Cells(23).Value.ToString(), DataGridView3.Rows(iRows).Cells(24).Value.ToString(), DataGridView3.Rows(iRows).Cells(25).Value.ToString(), DataGridView3.Rows(iRows).Cells(26).Value.ToString(), DataGridView3.Rows(iRows).Cells(27).Value.ToString(), DataGridView3.Rows(iRows).Cells(28).Value.ToString(), DataGridView3.Rows(iRows).Cells(29).Value.ToString(), DataGridView3.Rows(iRows).Cells(30).Value.ToString())
            Next
            '  DataGridView3.Rows.Add(lst(0), lst(1), lst(2), lst(3), lst(4), lst(5), lst(6), lst(7), lst(8), lst(9), lst(10), lst(11), lst(12), lst(13), lst(14), lst(15), lst(16), lst(17), lst(18), lst(19), lst(20), lst(21), lst(22), lst(23), lst(24), lst(25), lst(26), lst(27), lst(28), lst(29))
        ...
        ElseIf System.DateTime.DaysInMonth(dtpSubProject.Value.Year, dtpSubProject.Value.Month) = 28 Then
            ' DataGridView3.Rows.Add(lst(0), lst(1), lst(2), lst(3), lst(4), lst(5), lst(6), lst(7), lst(8), lst(9), lst(10), lst(11), lst(12), lst(13), lst(14), lst(15), lst(16), lst(17), lst(18), lst(19), lst(20), lst(21), lst(22), lst(23), lst(24), lst(25), lst(26), lst(27))
            For iRows As Integer = 0 To dgvSubProject.Rows.Count - 1
                dgvMerge.Rows.Add(dgvSubProject.Rows(iRows).Cells(0).Value.ToString, dgvSubProject.Rows(iRows).Cells(1).Value.ToString, dgvSubProject.Rows(iRows).Cells(2).Value.ToString(), dgvSubProject.Rows(iRows).Cells(3).Value.ToString(), dgvSubProject.Rows(iRows).Cells(4).Value.ToString(), dgvMerge.Rows.Add(dgvSubProject.Rows(iRows).Cells(0).Value.ToString, dgvSubProject.Rows(iRows).Cells(1).Value.ToString, dgvSubProject.Rows(iRows).Cells(2).Value.ToString(), dgvSubProject.Rows(iRows).Cells(3).Value.ToString(), dgvSubProject.Rows(iRows).Cells(4).Value.ToString(), DataGridView3.Rows(iRows).Cells(0).Value.ToString(), DataGridView3.Rows(iRows).Cells(1).Value.ToString(), DataGridView3.Rows(iRows).Cells(2).Value.ToString(), DataGridView3.Rows(iRows).Cells(3).Value.ToString(), DataGridView3.Rows(iRows).Cells(4).Value.ToString(), DataGridView3.Rows(iRows).Cells(5).Value.ToString(), DataGridView3.Rows(iRows).Cells(6).Value.ToString(), DataGridView3.Rows(iRows).Cells(7).Value.ToString(), DataGridView3.Rows(iRows).Cells(8).Value.ToString(), DataGridView3.Rows(iRows).Cells(9).Value.ToString(), DataGridView3.Rows(iRows).Cells(10).Value.ToString(), DataGridView3.Rows(iRows).Cells(11).Value.ToString(), DataGridView3.Rows(iRows).Cells(12).Value.ToString(), DataGridView3.Rows(iRows).Cells(13).Value.ToString(), DataGridView3.Rows(iRows).Cells(14).Value.ToString(), DataGridView3.Rows(iRows).Cells(15).Value.ToString(), DataGridView3.Rows(iRows).Cells(16).Value.ToString(), DataGridView3.Rows(iRows).Cells(17).Value.ToString(), DataGridView3.Rows(iRows).Cells(18).Value.ToString(), DataGridView3.Rows(iRows).Cells(19).Value.ToString(), DataGridView3.Rows(iRows).Cells(20).Value.ToString(), DataGridView3.Rows(iRows).Cells(21).Value.ToString(), DataGridView3.Rows(iRows).Cells(22).Value.ToString(), DataGridView3.Rows(iRows).Cells(23).Value.ToString(), DataGridView3.Rows(iRows).Cells(24).Value.ToString(), DataGridView3.Rows(iRows).Cells(25).Value.ToString(), DataGridView3.Rows(iRows).Cells(26).Value.ToString(), DataGridView3.Rows(iRows).Cells(27).Value.ToString(), DataGridView3.Rows(iRows).Cells(28).Value.ToString()))
            Next
        End If
    ...
    Sub subconPerSubcon()
        ...
        If days.Count = 0 Or countQuery.Count = 0 Then
            For i As Integer = 1 To System.DateTime.DaysInMonth(dtpAtt.Value.Year, dtpAtt.Value.Month)
                ...
                days.Add("[" & dd & "]")
                countQuery.Add("(SELECT COUNT(" & dd & ") FROM #tTemp WHERE [" & dd & "] = '1' AND #tTemp.subconName = tSubCon.subconName AND tProjectDet.ProjectName = #tTemp.ProjectName ) '" & dd & "'")
        ...
        Dim adaptor As New SqlDataAdapter(
            ...
            for ts in (" & result & ")
             ...
             SELECT DISTINCT tSubcon.subconName, #tTemp.projectName, " & result2 & " FROM tSubCon 
             INNER Join #tTemp On tSubCon.subconName = #tTemp.subconName
             JOIN tProjectDet on #tTemp.projectName = tProjectDet.projectName
             DROP TABLE #tTemp
            ", conn)
    ...
    Sub showATTReport()
        Try
          ...
          SELECT 
			   ...
			   AND DATEPART(yy,#t1.[timestamp]) = DATEPART(yy,#t2.[timestamp]) 
               LEFT JOIN tUserExternal ON tUserExternal.userId = #t1.userId
               LEFT JOIN tDeviceUser2 ON tDeviceUser2.userId = #t1.userId
               ORDER BY [Check In] asc
               DROP TABLE #t1
               DROP TABLE #t2
    ...
    Private Sub btnSearchDate_Click(sender As Object, e As EventArgs) Handles btnSearchDate.Click
        Try
            ...
            Dim adaptor As New SqlDataAdapter("
              ...
              SELECT DISTINCT * into #t1 FROM tReport WHERE [timestamp] BETWEEN '" & begin & "' AND '" & endtime & "'
               AND InOutMode = 'Check In'

               SELECT DISTINCT * into #t2 FROM tReport WHERE [timestamp] BETWEEN '" & begin & "' AND '" & endtime & "'
               AND InOutMode = 'Check Out' 
			   ...
			   CASE
					...
					#t1.userId
			   END
			   ) 'User ID', tDeviceUser2.section 'Section', tDeviceUser2.position 'Position',
    ...
    Private Sub btnGetOT_Click(sender As Object, e As EventArgs) Handles btnGetOT.Click
        ...
        Dim dd As String
        Dim days As New List(Of String)
        Dim queryFriday As New List(Of String)
        ...
        If txtOTname.Text = "" And cbbDeptOT.Text = "" Then
            ...
            For i As Integer = 1 To System.DateTime.DaysInMonth(dtpOT.Value.Year, dtpOT.Value.Month)
                ...
                'query.Add("CASE WHEN [" & dd & "] >= 1 THEN '1' WHEN [" & dd & "] <1 THEN ' ' END AS [" & dd & "]")
                'queryFriday.Add("CASE 
                '       WHEN [" & dd & "] < 1.0 THEN NULL 
                '          WHEN [" & dd & "] >= 1.0 AND [" & dd & "] < 2.5 THEN 1.5
                '       WHEN [" & dd & "] >= 2.5 AND [" & dd & "] < 3.0 THEN 2.5
                '       WHEN [" & dd & "] >= 3.0 AND [" & dd & "] < 3.5 THEN 4.5
                '       WHEN [" & dd & "] >= 3.5 AND [" & dd & "] < 4.5 THEN 6.5
                '       WHEN [" & dd & "] >= 4.5 AND [" & dd & "] < 5.5 THEN 8.5
                '       WHEN [" & dd & "] >= 5.5 AND [" & dd & "] < 6.5 THEN 10.5
                '          WHEN [" & dd & "] >= 7.0 AND [" & dd & "] < 8.5 THEN 12.5
                '       WHEN [" & dd & "] >= 8.5 AND [" & dd & "] < 9.5 THEN 14.5
                '       WHEN [" & dd & "] >= 9.5 AND [" & dd & "] < 10.5 THEN 16.5
                '       WHEN [" & dd & "] >= 10.5 AND [" & dd & "] < 11.5 THEN 18.5
                '       WHEN [" & dd & "] >= 12.5 AND [" & dd & "] < 13.5 THEN 20.5
                '       WHEN [" & dd & "] >= 13.5 AND [" & dd & "] < 14.5 THEN 22.5
                '          WHEN [" & dd & "] >= 14.5 AND [" & dd & "] < 15.5 THEN 24.5
                '       WHEN [" & dd & "] >= 15.5 AND [" & dd & "] < 16.5 THEN 26.5
                '       END AS [" & dd & "]")
                ...
                'CASE
                'WHEN DATENAME(weekday, '" & dd & "') = 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "')  THEN 
                '	CASE WHEN [" & dd & "] < 0.8 THEN NULL 
                '	WHEN [" & dd & "] >= 0.9 AND [" & dd & "] < 1.9 THEN 1.5
                '	WHEN [" & dd & "] >= 1.9 AND [" & dd & "] < 2.9 THEN 3.5
                '	WHEN [" & dd & "] >= 2.9 AND [" & dd & "] < 3.9 THEN 5.5
                '	WHEN [" & dd & "] >= 3.9 AND [" & dd & "] < 4.9 THEN 7.5
                '	WHEN [" & dd & "] >= 4.9 AND [" & dd & "] < 5.9 THEN 9.5
                '	WHEN [" & dd & "] >= 5.9 AND [" & dd & "] < 7.9 THEN 11.5
                '	WHEN [" & dd & "] >= 7.9 AND [" & dd & "] < 8.9 THEN 13.5
                '	WHEN [" & dd & "] >= 8.9 AND [" & dd & "] < 9.9 THEN 15.5
                '	WHEN [" & dd & "] >= 9.9 AND [" & dd & "] < 10.9 THEN 17.5
                '	WHEN [" & dd & "] >= 10.9 AND [" & dd & "] < 12.9 THEN 19.5
                '	WHEN [" & dd & "] >= 12.9 AND [" & dd & "] < 13.9 THEN 21.5
                '	WHEN [" & dd & "] >= 13.9 AND [" & dd & "] < 14.9 THEN 23.5
                '	WHEN [" & dd & "] >= 14.9  AND [" & dd & "] < 15.9 THEN 25.5
                '	END 

                '	WHEN EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "')  THEN 
                '	CASE WHEN [" & dd & "] < 0.8 THEN NULL 
                '	WHEN [" & dd & "] >= 0.8 AND [" & dd & "] < 1.8 THEN 2
                '	WHEN [" & dd & "] >= 1.8 AND [" & dd & "] < 2.8 THEN 4
                '	WHEN [" & dd & "] >= 2.8 AND [" & dd & "] < 3.8 THEN 6
                '	WHEN [" & dd & "] >= 3.8 AND [" & dd & "] < 4.8 THEN 8
                '	WHEN [" & dd & "] >= 4.8 AND [" & dd & "] < 6.8 THEN 10
                '	WHEN [" & dd & "] >= 6.8 AND [" & dd & "] < 7.8 THEN 12
                '	WHEN [" & dd & "] >= 7.8 AND [" & dd & "] < 8.8 THEN 14
                '	WHEN [" & dd & "] >= 8.8 AND [" & dd & "] < 9.8 THEN 17
                '	WHEN [" & dd & "] >= 9.8 AND [" & dd & "] < 10.4 THEN 19
                '	WHEN [" & dd & "] >= 10.4 AND [" & dd & "] < 11.8 THEN 23
                '	WHEN [" & dd & "] >= 11.8 AND [" & dd & "] < 12.8 THEN 27
                '	WHEN [" & dd & "] >= 12.8 AND [" & dd & "] < 13.8 THEN 31
                '	WHEN [" & dd & "] >= 13.8 AND [" & dd & "] < 14.8 THEN 35
                '	WHEN [" & dd & "] >= 14.8 AND [" & dd & "] < 16.8 THEN 39
                '             WHEN [" & dd & "] >= 16.8 AND [" & dd & "] < 17.8 THEN 43
                '	WHEN [" & dd & "] >= 17.8 AND [" & dd & "] < 18.8 THEN 47
                '	WHEN [" & dd & "] >= 18.8 AND [" & dd & "] < 19.8 THEN 51
                '	WHEN [" & dd & "] >= 19.8 AND [" & dd & "] < 21.8 THEN 55
                '	WHEN [" & dd & "] >= 21.8 AND [" & dd & "] < 22.8 THEN 59
                '	WHEN [" & dd & "] >= 22.8 AND [" & dd & "] < 23.8 THEN 63
                '	WHEN [" & dd & "] >= 23.8 AND [" & dd & "] < 24.8 THEN 67
                '	END 

                '	WHEN DATENAME(weekday, '" & dd & "') <> 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "') AND DATENAME(weekday, '" & dd & "') <> 'Saturday'   THEN 
                '		CASE WHEN [" & dd & "] < 0.8 THEN NULL 
                '		WHEN [" & dd & "] >= 0.8 AND [" & dd & "] < 1.8 THEN 1.5
                '		WHEN [" & dd & "] >= 1.8 AND [" & dd & "] < 2.4 THEN 2.5
                '		WHEN [" & dd & "] >= 2.4 AND [" & dd & "] < 3.8 THEN 4.5
                '		WHEN [" & dd & "] >= 3.8 AND [" & dd & "] < 4.8 THEN 6.5
                '		WHEN [" & dd & "] >= 4.8 AND [" & dd & "] < 5.8 THEN 8.5
                '		WHEN [" & dd & "] >= 5.8 AND [" & dd & "] < 6.8 THEN 10.5
                '		WHEN [" & dd & "] >= 6.8 AND [" & dd & "] < 8.8 THEN 12.5
                '		WHEN [" & dd & "] >= 8.8 AND [" & dd & "] < 9.8 THEN 14.5
                '		WHEN [" & dd & "] >= 9.8 AND [" & dd & "] < 10.8 THEN 16.5
                '		WHEN [" & dd & "] >= 10.8 AND [" & dd & "] < 11.8 THEN 18.5
                '		WHEN [" & dd & "] >= 11.8 AND [" & dd & "] < 13.8 THEN 20.5
                '		WHEN [" & dd & "] >= 13.8 AND [" & dd & "] < 14.8 THEN 22.5
                '		WHEN [" & dd & "] >= 14.8 AND [" & dd & "] < 15.8 THEN 24.5
                '		WHEN [" & dd & "] >= 15.8 AND [" & dd & "] < 16.8 THEN 26.5
                '	END

                '                 WHEN DATENAME(weekday, '" & dd & "') <> 'Saturday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "') THEN 
                '		CASE WHEN [" & dd & "] < 0.8 THEN NULL 
                '		WHEN [" & dd & "] >= 0.8 AND [" & dd & "] < 1.8 THEN 1.5
                '		WHEN [" & dd & "] >= 1.8 AND [" & dd & "] < 2.8 THEN 3.5
                '		WHEN [" & dd & "] >= 2.8 AND [" & dd & "] < 3.8 THEN 5.5
                '		WHEN [" & dd & "] >= 3.8 AND [" & dd & "] < 5.4 THEN 7.5
                '		WHEN [" & dd & "] >= 5.4 AND [" & dd & "] < 6.4 THEN 9.5
                '		WHEN [" & dd & "] >= 6.4 AND [" & dd & "] < 7.4 THEN 11.5
                '		WHEN [" & dd & "] >= 7.4 AND [" & dd & "] < 8.4 THEN 13.5
                '		WHEN [" & dd & "] >= 8.4 AND [" & dd & "] < 10.4 THEN 15.5
                '		WHEN [" & dd & "] >= 10.4 AND [" & dd & "] < 11.4 THEN 17.5
                '		WHEN [" & dd & "] >= 11.4 AND [" & dd & "] < 12.4 THEN 19.5
                '		WHEN [" & dd & "] >= 12.4 AND [" & dd & "] < 13.4 THEN 21.5
                '		WHEN [" & dd & "] >= 13.4 AND [" & dd & "] < 15.4 THEN 23.5
                '		WHEN [" & dd & "] >= 15.4 AND [" & dd & "] < 16.4 THEN 25.5
                '		WHEN [" & dd & "] >= 16.4 AND [" & dd & "] < 17.4 THEN 27.5
                '                 WHEN [" & dd & "] >= 17.4 AND [" & dd & "] < 18.4 THEN 29.5
                '	END
                'END AS [" & dd & "]")
			...
			CASE
			WHEN DATENAME(weekday, '" & dd & "') = 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "')  THEN 
				CASE WHEN [" & dd & "] < 54 THEN NULL 
				WHEN [" & dd & "] >= 55 AND [" & dd & "] < 90 THEN 1.5
				WHEN [" & dd & "] >= 145 AND [" & dd & "] < 200 THEN 3.5
				WHEN [" & dd & "] >= 201 AND [" & dd & "] < 264 THEN 5.5
				WHEN [" & dd & "] >= 265 AND [" & dd & "] < 324 THEN 7.5
				WHEN [" & dd & "] >= 325 AND [" & dd & "] < 384 THEN 9.5
				WHEN [" & dd & "] >= 385 AND [" & dd & "] < 444 THEN 9.5
				WHEN [" & dd & "] >= 445 AND [" & dd & "] < 504 THEN 11.5
				WHEN [" & dd & "] >= 505 AND [" & dd & "] < 564 THEN 13.5
				WHEN [" & dd & "] >= 565 AND [" & dd & "] < 624 THEN 15.5
				WHEN [" & dd & "] >= 625 AND [" & dd & "] < 684 THEN 17.5
				WHEN [" & dd & "] >= 685 AND [" & dd & "] < 744 THEN 17.5
				WHEN [" & dd & "] >= 745 AND [" & dd & "] < 804 THEN 19.5
				WHEN [" & dd & "] >= 805  AND [" & dd & "] < 864 THEN 21.5
                WHEN [" & dd & "] >= 865  AND [" & dd & "] < 924 THEN 23.5
                WHEN [" & dd & "] >= 925  AND [" & dd & "] < 984 THEN 25.5
				END 

				WHEN EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "') OR DATENAME(weekday, '" & dd & "') = 'Sunday' THEN 
				CASE WHEN [" & dd & "] < 54 THEN NULL 
				WHEN [" & dd & "] >= 55 AND [" & dd & "] < 114 THEN 2
				WHEN [" & dd & "] >= 115 AND [" & dd & "] < 174 THEN 4
				WHEN [" & dd & "] >= 175 AND [" & dd & "] < 234 THEN 6
				WHEN [" & dd & "] >= 235 AND [" & dd & "] < 294 THEN 8
				WHEN [" & dd & "] >= 295 AND [" & dd & "] < 354 THEN 8
				WHEN [" & dd & "] >= 355 AND [" & dd & "] < 414 THEN 10
				WHEN [" & dd & "] >= 415 AND [" & dd & "] < 474 THEN 12
				WHEN [" & dd & "] >= 475 AND [" & dd & "] < 534 THEN 14
				WHEN [" & dd & "] >= 535 AND [" & dd & "] < 564 THEN 17
				WHEN [" & dd & "] >= 565 AND [" & dd & "] < 594 THEN 19
				WHEN [" & dd & "] >= 595 AND [" & dd & "] < 654 THEN 19
				WHEN [" & dd & "] >= 655 AND [" & dd & "] < 714 THEN 23
				WHEN [" & dd & "] >= 715 AND [" & dd & "] < 774 THEN 27
				WHEN [" & dd & "] >= 775 AND [" & dd & "] < 834 THEN 31
                WHEN [" & dd & "] >= 835 AND [" & dd & "] < 894 THEN 35
				WHEN [" & dd & "] >= 895 AND [" & dd & "] < 954 THEN 35
				WHEN [" & dd & "] >= 955 AND [" & dd & "] < 1014 THEN 39
				WHEN [" & dd & "] >= 1015 AND [" & dd & "] < 1074 THEN 43
				WHEN [" & dd & "] >= 1075 AND [" & dd & "] < 1134 THEN 47
				WHEN [" & dd & "] >= 1135 AND [" & dd & "] < 1194 THEN 51
				WHEN [" & dd & "] >= 1195 AND [" & dd & "] < 1254 THEN 51
                WHEN [" & dd & "] >= 1255 AND [" & dd & "] < 1314 THEN 55
                WHEN [" & dd & "] >= 1315 AND [" & dd & "] < 1374 THEN 59
                WHEN [" & dd & "] >= 1375 AND [" & dd & "] < 1434 THEN 63
                WHEN [" & dd & "] >= 1435 AND [" & dd & "] < 1494 THEN 67
				END 
                
				WHEN DATENAME(weekday, '" & dd & "') <> 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "') AND DATENAME(weekday, '" & dd & "') <> 'Saturday'   THEN 
					CASE WHEN [" & dd & "] < 54 THEN NULL 
					WHEN [" & dd & "] >= 55 AND [" & dd & "] < 84  THEN 1.5
					WHEN [" & dd & "] >= 85 AND [" & dd & "] < 114 THEN 2.5
					WHEN [" & dd & "] >= 115 AND [" & dd & "] < 174 THEN 2.5
					WHEN [" & dd & "] >= 175 AND [" & dd & "] < 234 THEN 4.5
					WHEN [" & dd & "] >= 235 AND [" & dd & "] < 294 THEN 6.5
					WHEN [" & dd & "] >= 295 AND [" & dd & "] < 354 THEN 8.5
					WHEN [" & dd & "] >= 355 AND [" & dd & "] < 414 THEN 10.5
					WHEN [" & dd & "] >= 415 AND [" & dd & "] < 474 THEN 10.5
					WHEN [" & dd & "] >= 475 AND [" & dd & "] < 534 THEN 12.5
					WHEN [" & dd & "] >= 535 AND [" & dd & "] < 594 THEN 14.5
					WHEN [" & dd & "] >= 595 AND [" & dd & "] < 654 THEN 16.5
					WHEN [" & dd & "] >= 655 AND [" & dd & "] < 714 THEN 18.5
					WHEN [" & dd & "] >= 715 AND [" & dd & "] < 774 THEN 18.5
					WHEN [" & dd & "] >= 775 AND [" & dd & "] < 834 THEN 20.5
                    WHEN [" & dd & "] >= 835 AND [" & dd & "] < 894 THEN 22.5
					WHEN [" & dd & "] >= 895 AND [" & dd & "] < 954 THEN 24.5
                    WHEN [" & dd & "] >= 955 AND [" & dd & "] < 1014 THEN 26.5
                    END

                    WHEN DATENAME(weekday, '" & dd & "') = 'Saturday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE Holiday = '" & dd & "') THEN 
					CASE WHEN [" & dd & "] < 54 THEN NULL 
					WHEN [" & dd & "] >= 55 AND [" & dd & "] < 114 THEN 1.5
					WHEN [" & dd & "] >= 115 AND [" & dd & "] < 174 THEN 3.5
					WHEN [" & dd & "] >= 175 AND [" & dd & "] < 234 THEN 5.5
					WHEN [" & dd & "] >= 235 AND [" & dd & "] < 264 THEN 5.5
					WHEN [" & dd & "] >= 265 AND [" & dd & "] < 324 THEN 7.5
					WHEN [" & dd & "] >= 325 AND [" & dd & "] < 384 THEN 9.5
					WHEN [" & dd & "] >= 385 AND [" & dd & "] < 444 THEN 11.5
					WHEN [" & dd & "] >= 445 AND [" & dd & "] < 504 THEN 13.5
					WHEN [" & dd & "] >= 505 AND [" & dd & "] < 564 THEN 13.5
					WHEN [" & dd & "] >= 565 AND [" & dd & "] < 624 THEN 15.5
					WHEN [" & dd & "] >= 625 AND [" & dd & "] < 684 THEN 17.5
					WHEN [" & dd & "] >= 685 AND [" & dd & "] < 744 THEN 19.5
					WHEN [" & dd & "] >= 745 AND [" & dd & "] < 804 THEN 21.5
					WHEN [" & dd & "] >= 805 AND [" & dd & "] < 864 THEN 21.5
                    WHEN [" & dd & "] >= 865 AND [" & dd & "] < 924 THEN 23.5
                    WHEN [" & dd & "] >= 925 AND [" & dd & "] < 984 THEN 25.5
					WHEN [" & dd & "] >= 985 AND [" & dd & "] < 1044 THEN 27.5
					WHEN [" & dd & "] >= 1045 AND [" & dd & "] < 1104 THEN 29.5
				END
			END AS [" & dd & "]")
            ...
            Dim result2 As String = String.Join(",", queryFriday)
			...
			CASE 
			WHEN DATENAME(weekday,  FORMAT([timestamp], 'yyyy-MM-dd')) = 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE holiday =  FORMAT([timestamp], 'yyyy-MM-dd')) THEN FORMAT([timestamp], 'yyyy-MM-dd') + ' 16:30'
			WHEN EXISTS (SELECT * FROM tHoliday WHERE holiday =  FORMAT([timestamp], 'yyyy-MM-dd')) OR DATENAME(weekday, FORMAT([timestamp], 'yyyy-MM-dd')) = 'Sunday' THEN FORMAT([timestamp],'yyyy-MM-dd') + ' 08:00'
			WHEN DATENAME(weekday,  FORMAT([timestamp], 'yyyy-MM-dd')) <> 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE holiday =  FORMAT([timestamp], 'yyyy-MM-dd')) AND DATENAME(weekday,  FORMAT([timestamp], 'yyyy-MM-dd')) <> 'Saturday' THEN FORMAT([timestamp], 'yyyy-MM-dd') + ' 16:00'			
			WHEN DATENAME(weekday,  FORMAT([timestamp], 'yyyy-MM-dd')) = 'Saturday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE holiday =  FORMAT([timestamp], 'yyyy-MM-dd')) THEN FORMAT([timestamp], 'yyyy-MM-dd') + ' 14:30'
            END, [timestamp])
			)
            ...
            SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department',tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon' ," & result2 & "
        ...
        ElseIf txtOTname.Text = "" And cbbDeptOT.Text <> "" Then
			...
			WHEN [" & dd & "] >= 13.0 AND [" & dd & "] < 14.0 THEN 22.5
		    WHEN [" & dd & "] >= 14.0 AND [" & dd & "] < 15.0 THEN 24.5
			WHEN [" & dd & "] >= 15.0 AND [" & dd & "] < 16.0 THEN 26.5
			END")
            Next
  ...
  SELECT 
    ...
    Private Sub dgvGetOT_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvGetOT.CellContentClick
    ...
    Private Sub dgvReport_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvReport.CellDoubleClick
        ...
        Try
            ...
            SELECT 
             ...
             JOIN tUserExternal ON tReport.userId = tUserExternal.userId WHERE tReport.userId = '" & userId & "'
             AND DATEPART(dd,tReport.[timestamp]) = '" & dateValue.Day.ToString() & "'
             AND DATEPART(mm,tReport.[timestamp]) = '" & dateValue.Month.ToString() & "'
             AND DATEPART(yy,tReport.[timestamp]) = '" & dateValue.Year.ToString() & "'          
        ", conn)
            Dim ds As New DataSet
            adaptor.Fill(ds, "Report")
    ...
    Private Sub dgvEmployee_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvEmployee.CellDoubleClick
        openConnection()
        Dim index As Integer = dgvEmployee.CurrentCell.RowIndex()
        Dim userId, empName As String
        empName = dgvEmployee.Rows(index).Cells(2).Value.ToString
        Dim cmd As New SqlCommand("SELECT * FROM tDeviceUser2 WHERE employeeName = '" & empName & "'", conn)
        ...
        If dReader.HasRows = True Then
            ...
            userId = dReader.Item("userId").ToString
        End If

        Try
            Dim indexCol As Integer = dgvEmployee.CurrentCell.ColumnIndex
            Dim headerText As DateTime = Convert.ToDateTime(dgvEmployee.Columns(indexCol).HeaderText)
            Try
            ...
            SELECT 
             tReport.userId 'User ID',
	            ...
	            tReport.InOutMode 'In Out Mode'
             FROM tReport 
             FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = tReport.userId 
             FULL JOIN tUserExternal ON tReport.userId = tUserExternal.userId WHERE tReport.userId = '" & userId & "'
             AND DATEPART(dd,[timestamp]) = '" & headerText.Day.ToString & "'
             AND DATEPART(mm,[timestamp]) = '" & headerText.Month.ToString() & "'
             AND DATEPART(yy,[timestamp]) = '" & headerText.Year.ToString() & "'
        ", conn)
                Dim ds As New DataSet
                adaptor.Fill(ds, "Report")
                frmAttHistory.dgvHistory.DataSource = ds.Tables("Report")
                frmAttHistory.lblHistory.Text = "Jumlah Data  : " & frmAttHistory.dgvHistory.Rows.Count.ToString
                frmAttHistory.userId = dgvEmployee.Rows(index).Cells(1).Value.ToString()
                frmAttHistory.Show()
            Catch ex As Exception
                MsgBox(ex.ToString())
                saveError(ex.ToString())
    ...
    Private Sub cbbAttSC_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbbAttSC.SelectedIndexChanged

    End Sub

    Private Sub dgvGetOT_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvGetOT.CellDoubleClick
        openConnection()
        Dim index As Integer = dgvGetOT.CurrentCell.RowIndex()
        Dim userId, empName As String
        empName = dgvGetOT.Rows(index).Cells(2).Value.ToString
        Dim cmd As New SqlCommand("SELECT * FROM tDeviceUser2 WHERE employeeName = '" & empName & "'", conn)
        ...
        'Try
        Dim indexCol As Integer = dgvGetOT.CurrentCell.ColumnIndex
        Dim headerText As DateTime = Convert.ToDateTime(dgvGetOT.Columns(indexCol).HeaderText)
        '    Try
        ...
        frmAttHistory.dgvHistory.DataSource = ds.Tables("Report")
        frmAttHistory.lblHistory.Text = "Jumlah Data  : " & frmAttHistory.dgvHistory.Rows.Count.ToString
        frmAttHistory.userId = dgvGetOT.Rows(index).Cells(1).Value.ToString()
        frmAttHistory.Show()
        '    Catch ex As Exception
        '        MsgBox(ex.ToString())
        '        saveError(ex.ToString())
    ...
    Private Sub dgvLate_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvLate.CellDoubleClick
        openConnection()
        Dim index As Integer = dgvLate.CurrentCell.RowIndex()
        Dim userId, empName As String
        empName = dgvLate.Rows(index).Cells(2).Value.ToString
        Dim cmd As New SqlCommand("SELECT * FROM tDeviceUser2 WHERE employeeName = '" & empName & "'", conn)
        ...
        'Try
        Dim indexCol As Integer = dgvLate.CurrentCell.ColumnIndex
        Dim headerText As DateTime = Convert.ToDateTime(dgvLate.Columns(indexCol).HeaderText)
        '    Try
        ...
        frmAttHistory.dgvHistory.DataSource = ds.Tables("Report")
        frmAttHistory.lblHistory.Text = "Jumlah Data  : " & frmAttHistory.dgvHistory.Rows.Count.ToString
        frmAttHistory.userId = dgvLate.Rows(index).Cells(1).Value.ToString()
        frmAttHistory.Show()
        '    Catch ex As Exception
        '        MsgBox(ex.ToString())
        '        saveError(ex.ToString())
    ...
    Private Sub cbbLateSC_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbbLateSC.SelectedIndexChanged

    End Sub

    Private Sub cbbAttSC_KeyDown(sender As Object, e As KeyEventArgs) Handles cbbAttSC.KeyDown
        If e.KeyCode = Keys.Enter Then
            dsAttendance.Clear()
            dsAttendance.Tables.Clear()
            dgvEmployee.DataSource = Nothing
            ...
            FROM #tTemp INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tTemp.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tTemp.userId 
            WHERE tUserExternal.subcon = '" & cbbAttSC.Text & "'
    ...
    Private Sub cbbEPSubcon_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbbEPSubcon.SelectedIndexChanged

    End Sub

    Private Sub cbbDepart_KeyDown(sender As Object, e As KeyEventArgs) Handles cbbDepart.KeyDown

    End Sub

    Private Sub cbbSCOT_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbbSCOT.SelectedIndexChanged

    End Sub

    Private Sub cbbLateSC_KeyDown(sender As Object, e As KeyEventArgs) Handles cbbLateSC.KeyDown
        dsLate.Clear()
        dsLate.Tables.Clear()
        dgvLate.DataSource = Nothing
        dgvLate.Rows.Clear()
        ...
        Try
            ...
            SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department', tDeviceUser2.position 'Position', tDeviceUser2.section 'Section', tUserExternal.subcon 'Subcon',  " & result & "
            FROM #tLate FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId 
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId WHERE tUserExternal.subcon = '" & cbbLateSC.Text & "' ORDER BY tDeviceUser2.userId ASC 
    ...
    Private Sub cbbProject_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbbProject.SelectedIndexChanged

    End Sub

    Private Sub cbbEPSubcon_KeyDown(sender As Object, e As KeyEventArgs) Handles cbbEPSubcon.KeyDown
        '  Try
        ...
        Try
            ...
            adaptor = New SqlDataAdapter("
                ...
                SELECT tDeviceUser2.employeeNo 'Employee No', tDeviceUser2.employeeName 'Employee Name', tDeviceUser2.departmentName 'Department',tDeviceUser2.section 'Section', tDeviceUser2.position 'Position', tUserExternal.subcon 'Subcon', " & result & "
                FROM #tLate INNER JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId
                LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId where tUserExternal.subcon = '" & cbbEPSubcon.Text & "'
                ORDER BY tDeviceUser2.userId ASC
    ...
    Private Sub dgvMerge_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvMerge.CellContentClick

    End Sub

    Private Sub cbbSCOT_KeyDown(sender As Object, e As KeyEventArgs) Handles cbbSCOT.KeyDown
        If e.KeyCode = Keys.Enter Then
            dsOT.Clear()
            dsOT.Tables.Clear()
            dgvGetOT.DataSource = Nothing
            ...
            SELECT tReport.userId, FORMAT([timestamp], 'yyyy-MM-dd') 'timestamp', 
            (
		    SELECT DATEDIFF(minute,  
			CASE 
			WHEN DATENAME(weekday,  FORMAT([timestamp], 'yyyy-MM-dd')) = 'Friday' AND NOT EXISTS (SELECT * FROM tHoliday WHERE holiday =  FORMAT([timestamp], 'yyyy-MM-dd')) THEN FORMAT([timestamp], 'yyyy-MM-dd') + ' 16:30'
            ...
            FROM #tLate FULL JOIN tDeviceUser2 ON tDeviceUser2.userId = #tLate.userId
            LEFT JOIN tUserExternal ON tUserExternal.userId = #tLate.userId WHERE tUserExternal.subcon = '" & cbbSCOT.Text & "'
            ORDER BY tDeviceUser2.userId ASC
    ...
    Private Sub cbbProject_KeyDown(sender As Object, e As KeyEventArgs) Handles cbbProject.KeyDown
        If e.KeyCode = Keys.Enter Then
    ...
    Private Sub dgvMerge_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvMerge.CellDoubleClick
        openConnection()
        Dim subconName, projectName As String
        Dim index = dgvMerge.CurrentCell.RowIndex()
        projectName = dgvMerge.Rows(index).Cells(1).Value.ToString
        subconName = dgvMerge.Rows(index).Cells(3).Value.ToString
        ' Try
        Dim indexCol As Integer = dgvMerge.CurrentCell.ColumnIndex
        Dim headerText As DateTime = Convert.ToDateTime(dtpSubProject.Value.Year & "-" & dtpSubProject.Value.Month.ToString("00") & "-" & dgvMerge.Columns(indexCol).HeaderText)

        ' Try

        Dim adaptor As New SqlDataAdapter("
                           SELECT DISTINCT tprojectemp.employeeno 'Employee Number', tprojectemp.employeename 'Employee Name',  tprojectemp.subconid 'Subcon ID',
                tprojectemp.subconname 'Subcon',
                treport.[timestamp] 'Time Stamp',tprojectemp.projectcode 'Project Code',
                tprojectemp.projectname 'Project Name'
                from tprojectemp 
                inner join tdeviceuser2 on tdeviceuser2.employeeno = tprojectemp.employeeno 
                inner join treport on tprojectemp.employeeName = treport.personellName where projectName = '" & projectName & "'
                and subconName = '" & subconName & "'
                and datepart(yy,[timestamp]) = '" & dtpSubProject.Value.Year & "'
                and datepart(mm,[timestamp]) = '" & dtpSubProject.Value.Month.ToString("00") & "'
                and datepart(dd,[timestamp]) = '" & headerText.Day.ToString("00") & "'
                and inoutmode = 'check in'
        ", conn)
